...
def visual_pos(motion_path, save_path = './motion_output/59.mp4', caption = ' ', target_pos=None):
...
#    motion_path = './datasets/cmu_new/test_file/000059.npy'
    ...
    plot_3d_motion(save_path, skeleton, motion, caption, fps=20, target_pos=target_pos)
