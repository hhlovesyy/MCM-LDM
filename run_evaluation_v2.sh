...
# python /root/autodl-tmp/MCM-LDM_Evaluation/MCM-LDM_Evaluation/calc_traj_metrics.py --pkl_path="${FMD_CRA_PKL_PATH}" --gt_joints_dir="/root/autodl-tmp/MyRepository/MCM-LDM/demo/content_test_joints" 2>&1 | tee -a "${RESULTS_FILE}"
# echo "====================================================="
...
# 基础配置路径
CONFIG_MLD="./configs/config_mld_humanml3d_1210.yaml" # /root/autodl-tmp/MyRepository/MCM-LDM/configs/config_mld_humanml3d_1209 copy.yaml
CONFIG_ASSETS="./configs/assets.yaml"
SCALE="2.5"

# 模型名称 (用于生成输出文件名的一部分)
EXP_NAME="SceMoDiff_Evaluation_2" # 假设您有一个统一的实验名称
EVAL_ID=0
