...
def parse_args(phase="train"):
    ...
    if phase == "demo":
        ...
        group.add_argument(
            ...
            type=str,
            required=False,
            help="input style text with txt format",
        )
        group.add_argument(
            "--MOTION",
...
######################################################################################################################################################
    ...
    if phase == "demo":
        ...
        cfg.DEMO.MOTION = params.MOTION
        cfg.DEMO.scale = params.scale
        cfg.DEMO.style_motion_dir = params.style_motion_dir
        cfg.DEMO.content_motion_dir = params.content_motion_dir
        cfg.DEMO.TIME = params.TIME
