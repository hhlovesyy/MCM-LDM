...
from .humanml.data.dataset import Text2MotionDatasetV2, TextOnlyDataset, Scene100StyleDataset

class StyleSceneDataModule(BASEDataModule): # 可以大胆继承于BASEDataModule，因为数据集的文件结构基本是一致的
    def __init__(self,
                 cfg,
                 batch_size,
                 num_workers,
        ...
        self.name = "stylescenedataset"
        self.njoints = 22
        self.Dataset = Scene100StyleDataset
        self.cfg = cfg
        self.nfeats = 263
