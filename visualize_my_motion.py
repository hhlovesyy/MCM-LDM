...
NPY_FILE_TO_VISUALIZE = "/root/autodl-tmp/HumanML3D/HumanML3D/dataset_res/npy_input_narrowgap_02_10/npy_output/Gap_35cm_OffNeg5_Alpha1p0_0278.npy" # <-- 请修改我！把Blender产出的windows操作系统下的文件上传到Linux服务器上
