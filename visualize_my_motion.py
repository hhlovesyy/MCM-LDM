...
NPY_FILE_TO_VISUALIZE = "/root/autodl-tmp/HumanML3D/HumanML3D/dataset_res/npy_input_ceiling/npy_output/Ceiling_Front_80cm_Alpha0p0_0025.npy" # <-- 请修改我！把Blender产出的windows操作系统下的文件上传到Linux服务器上
